...
export interface Calendar {
     ...
     */
    unsetWorkTime(config: { day?: string | number; date?: Date; hours?: Array<string | number> | boolean }): void;
...
export interface InlineEditorMethods {
     ...
     */
    setMapping(mapping: { init: Function; onShow: Function; onHide: Function; destroy: Function }): void;
...
export interface InlineEditorEvents {
    ...
    onBeforeSave: (state: { id: number | string; columnName: string; oldValue: any; newValue: any }) => any;
...
export interface Tooltips {
    ...
    attach(config: {
        selector: string;
        onmouseenter: (event: MouseEvent, node: HTMLElement) => any;
        onmousemove?: (event: MouseEvent, node: HTMLElement) => any;
        onmouseleave: (event: MouseEvent, node: HTMLElement) => any;
        global?: boolean;
    }): void;
     ...
     */
    tooltipFor(config: { selector: string; html: (event: Event, node: HTMLElement) => any; global?: boolean }): void;
